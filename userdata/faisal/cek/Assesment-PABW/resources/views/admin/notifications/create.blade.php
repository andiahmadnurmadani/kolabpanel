...
<head>
    ...
    <title>Tambah Notifikasi - DonGiv Admin</title>
...
<body class="min-h-screen flex">
    ...
    <div class="flex-1 p-8 overflow-auto">
        <header class="mb-8 fade-in">
            <h2 class="text-3xl font-bold text-gray-800">Tambah Notifikasi Baru</h2>
            <p class="text-gray-600">Buat pesan notifikasi untuk pengguna</p>
        </header>
        ...
        <div class="card p-8 rounded-2xl fade-in max-w-3xl mx-auto">
            <form action="{{ route('admin.notifications.store') }}" method="POST" class="space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="text" name="title" class="input-field w-full border border-gray-200 p-4 rounded-xl focus:outline-none focus:border-blue-300 pl-12 bg-gray-50/50 @error('title') border-red-300 @enderror"
                ...
                <div class="mb-6">
                    <label for="message" class="block text-gray-700 font-semibold mb-2">
                        <i class="fas fa-align-left mr-2 text-blue-500"></i>Pesan
                    </label>
                    <div class="relative">
                        <textarea name="message" rows="5" class="input-field w-full border border-gray-200 p-4 rounded-xl focus:outline-none focus:border-blue-300 pl-12 bg-gray-50/50 @error('message') border-red-300 @enderror"
                                  required placeholder="Tulis pesan notifikasi">{{ old('message') }}</textarea>
                ...
                <div class="flex space-x-4 pt-4">
                    <button type="submit" class="btn-primary flex-1 py-4 px-6 rounded-xl text-white font-semibold text-lg relative overflow-hidden">
                        <span class="relative z-10"><i class="fas fa-save mr-2"></i>Simpan Notifikasi</span>
